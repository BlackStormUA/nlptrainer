...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController1?.text = 'Jane Doe';
          _model.textController2?.text = 'Mrs. Joe';
          _model.textController3?.text = '01/12/1990';
          _model.textController4?.text = 'jane@example.com';
          _model.textController5?.text = '+ 250 700 000 000';
        }));
  }
